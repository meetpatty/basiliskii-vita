...
#elif defined(FPU_SOFT)

#if HOST_FLOAT_FORMAT != SOFT_FLOAT_FORMAT
#error "No SoftFloat format, you lose."
#endif

#include "fpu/softfloat/softfloat.h"

/* 4-byte floats */
typedef float32 uae_f32;

/* 8-byte floats */
typedef float64 uae_f64;

/* 10-byte floats */
typedef floatx80 uae_f96;
typedef uae_f96 fpu_register;
#define USE_LONG_DOUBLE 1
