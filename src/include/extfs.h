...
extern int open_dfork(const char *path, int flag);
...
extern off_t extfs_seek(int fd, off_t offset, int whence);
extern int extfs_fstat(int fd, struct stat *buf);
extern int extfs_ftruncate(int fildes, off_t length);
