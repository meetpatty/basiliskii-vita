...
user_string_def platform_strings[] = {
    ...
    {STR_PSP_SERIAL, "Vita Serial"},
    {STR_PSP_IRDA, "Vita IRDA"},
    {STR_ACCESS_POINT, "Network Access Point"},

	{STR_PSP_PANE_TITLE, "Vita Specific Settings"},
	{STR_PSP_CPU_FREQ, "Vita CPU Clock Frequency"},
	{STR_PSP_VIDEO_OUT, "Vita Video Output"},
	{STR_PSP_LCD_PANE_TITLE, "Vita LCD Settings"},
	{STR_PSP_TV_PANE_TITLE, "Vita TV Settings"},
